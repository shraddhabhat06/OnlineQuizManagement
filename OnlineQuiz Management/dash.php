...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php?q=0"><b>Examiner</b></a>
    </div>
...
$c++;
echo '<tr><td>'.$c.'</td><td>'.$name.'</td><td>'.$email.'</td><td>'.$gender.'</td><td>'.$collegename.'</td><td>'.$s.'</td><td>';
}
echo '</table></div></div>';}
...
$result = mysqli_query($con,"SELECT * FROM candidate") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
...
while($row = mysqli_fetch_array($result)) {
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$gender.'</td><td>'.$collegename.'</td><td>'.$email.'</td><td>'.$phno.'</td>';
}
$c=0;
echo '</table></div></div>';
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="'.$i.'1" required></label>  
  <div class="col-md-12">
