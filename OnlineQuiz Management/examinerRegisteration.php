<?php
    ...
    $cpassword = ($_POST['cpassword']);
		...
		$str="SELECT email from examiner WHERE email='$email'";
      ...
      header("refresh:0;url=examinerRegisteration.php");
    }
		else
		{
      $str="insert into examiner set name='$name', lname='$lname', gender='$gender', dob='$dob',address='$address', collegename='$collegename',phno='$phno',email='$email',password='$password', cpassword='$cpassword'";
			if((mysqli_query($con,$str)))
			echo "<center><h3><script>alert('You have successfully registered !');</script></h3></center>";
			header('location: examinerLogin.php?q=1');
...
<body>
  <div class="container">
    <div class="title"><i class="fas fa-chalkboard-teacher"></i> Examiner Registration</div>
    <div class="content">
      <form  method="post" action="examinerRegisteration.php" enctype="multipart/form-data">
        <div class="user-details">
          <div class="input-box">
            <span class="details">First Name</span>
            <input type="text" nameplaceholder="Enter your First name" name="name" required>
        ...
        <div class="button">
          <a href="http://localhost/Project/examinerLogin.php"><input type="submit" name="submit" value="Register"></a>
        </div>
      </form>
    </div>
  </div>
